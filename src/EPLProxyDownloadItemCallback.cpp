...
#include <proxy/ProxyDownloadItemCallback.h>
...
void EDITIONF(ProxyDownloadItemCallback_Destructor)(PMDATA_INF pRetData, INT nArgCount, PMDATA_INF pArgInf){
	...
	shrewd_ptr<ProxyDownloadItemCallback> ptr = (ProxyDownloadItemCallback*)*pArgInf->m_ppCompoundData;
...
void EDITIONF(ProxyDownloadItemCallback_CopyConstructor)(PMDATA_INF pRetData, INT nArgCount, PMDATA_INF pArgInf){
	...
	shrewd_ptr<ProxyDownloadItemCallback> ptr = (ProxyDownloadItemCallback*)*pArgInf[1].m_ppCompoundData;
...
void EDITIONF(ProxyDownloadItemCallback_Cancel) (PMDATA_INF pRetData, INT nArgCount, PMDATA_INF pArgInf){
	...
	shrewd_ptr<ProxyDownloadItemCallback> self = (ProxyDownloadItemCallback*)*pArgInf->m_ppCompoundData;
	self->Cancel();
}
