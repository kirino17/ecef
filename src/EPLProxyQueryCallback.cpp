...
#include <proxy/ProxyQueryCallback.h>
...
void EDITIONF(ProxyQueryCallback_Destructor)(PMDATA_INF pRetData, INT nArgCount, PMDATA_INF pArgInf){
	...
	shrewd_ptr<ProxyQueryCallback> ptr = (ProxyQueryCallback*)*pArgInf->m_ppCompoundData;
...
void EDITIONF(ProxyQueryCallback_CopyConstructor)(PMDATA_INF pRetData, INT nArgCount, PMDATA_INF pArgInf){
	...
	shrewd_ptr<ProxyQueryCallback> ptr = (ProxyQueryCallback*)*pArgInf[1].m_ppCompoundData;
...
void EDITIONF(ProxyQueryCallback_Success) (PMDATA_INF pRetData, INT nArgCount, PMDATA_INF pArgInf){
	...
	shrewd_ptr<ProxyQueryCallback> self = (ProxyQueryCallback*)*pArgInf->m_ppCompoundData;
	const char* argResponse = (NULL==pArgInf[1].m_pText || strlen(pArgInf[1].m_pText) <= 0) ? NULL : pArgInf[1].m_pText;
	self->Success(argResponse);
}
