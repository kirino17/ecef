...
//
// $hash=21a69ddea4f9560049d32f7268cc003656a3c5b1$
//
...
NO_SANITIZE("cfi-icall")
void CefFrameCToCpp::SynthesizePinchGesture(float x,
                                            float y,
                                            float scale_factor,
  ...
  cef_frame_t* _struct = GetStruct();
  if (CEF_MEMBER_MISSING(_struct, synthesize_pinch_gesture))
    return;

  // AUTO-GENERATED CONTENT - DELETE THIS COMMENT BEFORE MODIFYING

  // Execute
  _struct->synthesize_pinch_gesture(_struct, x, y, scale_factor, relative_speed,
                                    gesture_source_type);
}

NO_SANITIZE("cfi-icall")
void CefFrameCToCpp::SynthesizeScrollGesture(float x,
                                             float y,
                                             float x_distance,
                                             float y_distance,
                                             float x_overscroll,
  ...
  cef_frame_t* _struct = GetStruct();
  if (CEF_MEMBER_MISSING(_struct, synthesize_scroll_gesture))
    return;

  // AUTO-GENERATED CONTENT - DELETE THIS COMMENT BEFORE MODIFYING

  // Execute
  _struct->synthesize_scroll_gesture(_struct, x, y, x_distance, y_distance,
                                     x_overscroll, y_overscroll, scale_factor,
                                     prevent_fling, speed, gesture_source_type);
}

NO_SANITIZE("cfi-icall")
void CefFrameCToCpp::SynthesizeTapGesture(float x,
                                          float y,
                                          float scale_factor,
                                          int duration,
                                          int tap_count,
  ...
  cef_frame_t* _struct = GetStruct();
  if (CEF_MEMBER_MISSING(_struct, synthesize_tap_gesture))
    return;

  // AUTO-GENERATED CONTENT - DELETE THIS COMMENT BEFORE MODIFYING

  // Execute
  _struct->synthesize_tap_gesture(_struct, x, y, scale_factor, duration,
                                  tap_count, gesture_source_type);
}

NO_SANITIZE("cfi-icall")
void CefFrameCToCpp::SynthesizeDragGesture(float x_start_position,
  ...
  cef_frame_t* _struct = GetStruct();
  if (CEF_MEMBER_MISSING(_struct, synthesize_drag_gesture))
    return;

  // AUTO-GENERATED CONTENT - DELETE THIS COMMENT BEFORE MODIFYING

  // Execute
  _struct->synthesize_drag_gesture(_struct, x_start_position, y_start_position,
                                   x_distance, y_distance, scale_factor, speed,
                                   gesture_source_type);
}

NO_SANITIZE("cfi-icall")
void CefFrameCToCpp::SetEmitTouchEventsForMouse(bool enabled,
                                                int configuration) {
  shutdown_checker::AssertNotShutdown();

  cef_frame_t* _struct = GetStruct();
  if (CEF_MEMBER_MISSING(_struct, set_emit_touch_events_for_mouse))
    return;

  // AUTO-GENERATED CONTENT - DELETE THIS COMMENT BEFORE MODIFYING

  // Execute
  _struct->set_emit_touch_events_for_mouse(_struct, enabled, configuration);
}
