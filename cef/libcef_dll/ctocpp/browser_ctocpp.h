...
//
// $hash=7482c27f3752e89dd08ffefb8ee79b5e87b4527e$
//
...
class CefBrowserCToCpp
 ...
 public:
  ...
  void SetTouchEventEmulationEnabled(bool enabled, int maxTouchPoints) OVERRIDE;
  void SetGeolocationOverride(float latitude,
                              float longitude,
                              float accuracy) OVERRIDE;
  void SetEmulatedMedia(const CefString& media,
                        CefRefPtr<CefDictionaryValue> features) OVERRIDE;
  void ClearMediaFeatureOverrides() OVERRIDE;
  void EnableDeviceEmulation(
      CefRefPtr<CefDeviceEmulationParams> params) OVERRIDE;
